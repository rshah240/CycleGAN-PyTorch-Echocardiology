...
class Echocardiology(Dataset):
    def __init__(self, 
                 src_images_dir: str,
                 dst_images_dir: str,
                 unpaired: bool,
                 resized_image_size: tuple,
                 transforms: transforms):
        super(Echocardiology, self).__init__()
        self.src_image_file_names = [os.path.join(src_images_dir, img) for img in os.listdir(src_images_dir)]
        self.dst_image_file_names = [os.path.join(dst_images_dir, img) for img in os.listdir(dst_images_dir)]
    ...
    def __getitem__(self, index) -> dict:
        ...
        dst_tensor = self.transform(dst_image)

        dict_item = {'src': src_tensor, 'dst': dst_tensor}
